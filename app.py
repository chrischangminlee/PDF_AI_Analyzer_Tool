...
st.markdown("""
PDF분석, **시간이 오래걸리더라도** 퀄리티있는 답변을 추출하고자 만들어 보았습니다.<br><br>
본 PDF AI 세부 분석 Tool은 **단계적 AI활용**과 Human Input을 통해 AI 환각효과를 최소화 하고자 합니다.<br>
현재 무료버전을 사용하고 있어 일일 API 사용량이 제한되어 당일 사용이 불가능할 수도 있습니다.<br>
